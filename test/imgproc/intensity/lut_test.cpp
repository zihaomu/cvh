...
TEST(LutTest, u8_c1_lut_c1_matches_reference)
{
    Mat src({5, 7}, CV_8UC1);
...
TEST(LutTest, u8_c3_lut_c1_roi_matches_reference)
{
...
TEST(LutTest, u8_c4_lut_c4_matches_reference)
{
    Mat src({4, 6}, CV_8UC4);
...
TEST(LutTest, output_depth_follows_lut_f32)
{
    Mat src({3, 5}, CV_8UC1);
...
TEST(LutTest, supports_non_contiguous_lut_storage)
{
...
TEST(LutTest, supports_in_place_src_equals_dst)
{
    Mat src({5, 5}, CV_8UC1);
...
TEST(LutTest, throws_on_invalid_arguments)
{
    Mat dst;
    Mat empty;
