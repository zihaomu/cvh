...
TEST(TransformMatrixTest, rotation_matrix_covers_identity_scale_and_center)
{
...
TEST(TransformMatrixTest, affine_maps_float_and_double_control_points)
{
...
TEST(TransformMatrixTest, perspective_maps_four_points)
{
...
TEST(TransformMatrixTest, inverse_composes_and_supports_aliasing)
{
...
TEST(TransformMatrixTest, degenerate_inputs_have_fixed_behavior)
{
