...
TEST(SepFilter2DTest, u8_c3_matches_filter2d_outer_product)
{
    Mat src({7, 9}, CV_8UC3);
...
TEST(SepFilter2DTest, f32_custom_anchor_delta_matches_filter2d_outer_product)
{
...
TEST(SepFilter2DTest, u8_to_f32_depth_matches_filter2d_outer_product)
{
    Mat src({5, 7}, CV_8UC1);
...
TEST(SepFilter2DTest, roi_non_contiguous_and_inplace_are_supported)
{
...
TEST(SepFilter2DTest, throws_on_invalid_arguments)
{
    Mat dst;
    Mat empty;
    Mat src({4, 5}, CV_8UC1);
