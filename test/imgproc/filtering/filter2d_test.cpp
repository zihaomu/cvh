...
TEST(Filter2DTest, u8_c3_matches_reference_replicate_border)
{
    Mat src({7, 9}, CV_8UC3);
...
TEST(Filter2DTest, f32_c1_custom_anchor_and_delta_matches_reference)
{
...
TEST(Filter2DTest, u8_to_f32_output_depth_matches_reference)
{
    Mat src({5, 7}, CV_8UC1);
...
TEST(Filter2DTest, roi_non_contiguous_and_inplace_are_supported)
{
...
TEST(Filter2DTest, throws_on_invalid_arguments)
{
    Mat dst;
    Mat empty;
    Mat src({4, 5}, CV_8UC1);
