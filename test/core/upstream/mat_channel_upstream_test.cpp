...
TEST(MatChannelUpstreamTest, Core_Merge_shape_operations)
{
    Mat c0({2, 3}, CV_8UC1);
    Mat c1({2, 3}, CV_8UC2);
...
TEST(MatChannelUpstreamTest, Core_Split_shape_operations)
{
...
TEST(MatChannelUpstreamTest, Core_Merge_hang_12171)
{
...
TEST(MatChannelUpstreamTest, Core_Split_hang_12171)
{
...
TEST(MatChannelUpstreamTest, Core_Split_crash_12171)
{
...
TEST(MatChannelUpstreamTest, Core_Merge_bug_13544)
{
...
TEST(MatChannelUpstreamTest, Core_Mat_reinterpret_Mat_8UC3_8SC3)
{
    Mat A({8, 16}, CV_8UC3);
...
TEST(MatChannelUpstreamTest, Core_Mat_reinterpret_Mat_8UC4_32FC1)
{
    Mat A({8, 16}, CV_8UC4);
...
TEST(MatChannelUpstreamTest, Core_MatExpr_issue_16655)
{
    Mat a({5, 5}, CV_32FC3);
    Mat b({5, 5}, CV_32FC3);
...
TEST(MatChannelUpstreamTest, Subtract_scalarc1_matc3)
{
    int scalar = 255;
...
TEST(MatChannelUpstreamTest, Subtract_scalarc4_matc4)
{
...
TEST(MatChannelUpstreamTest, Compare_empty)
{
    Mat temp;
    Mat dst1;
    Mat dst2;
...
TEST(MatChannelUpstreamTest, Compare_regression_8999)
{
    Mat A({4, 1}, CV_32F);
    Mat B({1, 1}, CV_32F);
    A.at<float>(0, 0) = 1.0f;
...
TEST(MatChannelUpstreamTest, Compare_regression_16F_do_not_crash)
{
...
TEST(MatChannelUpstreamTest, Core_Array_expressions)
{
...
TEST(MatChannelUpstreamTest, Core_LUT_accuracy)
{
...
TEST(MatChannelUpstreamTest, Core_LUT_accuracy_multi)
{
...
TEST(MatChannelUpstreamTest, Core_LUT_accuracy_multi2)
{
    Mat input({117, 113}, CV_8UC3);
