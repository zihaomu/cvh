...
TEST(ReductionTest, norm_values_mask_and_two_input_forms)
{
...
TEST(ReductionTest, sum_mean_stddev_cover_c3_mask_and_roi)
{
...
TEST(ReductionTest, statistics_cover_c4_single_and_identical_values)
{
    Mat c4({1, 2}, CV_64FC4);
...
TEST(ReductionTest, nonzero_predicates_and_locations_are_row_major)
{
...
TEST(ReductionTest, nonzero_apis_reject_multichannel_input)
{
    Mat src({1, 3}, CV_8UC3);
    Mat out;
    std::vector<Point> points;
...
TEST(ReductionTest, minmax_ties_use_first_row_major_location)
{
...
TEST(ReductionTest, minmaxidx_reports_nd_coordinates)
{
...
TEST(ReductionTest, reduce_axis_shape_type_and_values_match_contract)
{
...
TEST(ReductionTest, reduce_arg_ties_support_first_and_last_index)
{
...
TEST(ReductionTest, normalize_supports_norms_minmax_dtype_mask_and_alias)
{
...
TEST(ReductionTest, empty_zero_nan_inf_and_thread_settings_are_stable)
{
    Mat empty;
...
TEST(ReductionTest, invalid_axes_types_and_masks_throw)
{
    Mat c3({2, 3}, CV_8UC3);
    Mat c1({2, 3}, CV_8UC1);
