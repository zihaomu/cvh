...
TEST(ArrayLayoutTest, border_interpolate_matches_documented_modes)
{
    ...
    EXPECT_EQ(borderInterpolate(-2048, 160, BORDER_REFLECT_101), 140);
    EXPECT_EQ(borderInterpolate(2047, 160, BORDER_REFLECT_101), 139);
    EXPECT_EQ(borderInterpolate(-2048, 160, BORDER_REFLECT), 127);
    EXPECT_EQ(borderInterpolate(2047, 160, BORDER_REFLECT), 127);
...
TEST(ArrayLayoutTest, copy_to_mask_roi_and_overlap_are_defined)
{
...
TEST(ArrayLayoutTest, copy_class_preserves_bytes_across_depths_and_channels)
{
    const int types[] = {
        CV_8UC4,
        CV_8SC3,
...
TEST(ArrayLayoutTest, channel_extract_insert_and_mix_route_raw_scalars)
{
...
TEST(ArrayLayoutTest, flip_rotate_repeat_and_alias_match_geometry)
{
...
TEST(ArrayLayoutTest, flip_nd_covers_1d_2d_3d_and_negative_axis)
{
...
TEST(ArrayLayoutTest, concat_validates_shapes_and_supports_output_alias)
{
...
TEST(ArrayLayoutTest, broadcast_uses_trailing_dimension_rules)
{
...
TEST(ArrayLayoutTest, swap_exchanges_headers_without_copying_pixels)
{
    Mat a({2, 3}, CV_8UC1);
    Mat b({4, 1}, CV_32FC2);
...
TEST(ArrayLayoutTest, invalid_channel_layout_and_geometry_inputs_throw)
{
    Mat c3({2, 3}, CV_8UC3);
    Mat c1({2, 3}, CV_8UC1);
