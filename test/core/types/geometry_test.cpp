...
TEST(GeometryTest, point_alias_preserves_existing_integer_api)
{
...
TEST(GeometryTest, point_float_double_and_conversion_are_available)
{
...
TEST(GeometryTest, size_alias_preserves_existing_integer_api)
{
...
TEST(GeometryTest, floating_size_conversion_is_available)
{
