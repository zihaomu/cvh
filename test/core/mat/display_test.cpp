...
TEST(MatDisplayTest, shape_semantics_remain_geometry_only)
{
    Mat m({2, 3}, CV_8UC3);
...
TEST(MatDisplayTest, display_policy_only_applies_channel_first_to_2d_multichannel)
{
    Mat gray({2, 3}, CV_8U);
...
TEST(MatDisplayTest, print_and_printshape_use_display_policy)
{
    Mat m({2, 3}, CV_8UC3);
    m = 0;
