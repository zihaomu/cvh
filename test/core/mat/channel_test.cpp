...
TEST(MatChannelTest, opencv_like_type_macros_encode_decode_channels)
{
...
TEST(MatChannelTest, create_setto_and_copyto_cover_all_channel_elements)
{
    Mat src({2, 2}, CV_8UC3);
...
TEST(MatChannelTest, convertto_keeps_channels_when_rtype_is_depth)
{
