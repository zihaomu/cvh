...
TEST(MatExpressionTest, scalar_arithmetic_overloads_for_mat_and_matexpr)
{
    Mat a({1, 2}, CV_32SC3);
...
TEST(MatExpressionTest, compare_ops_return_u8c_mask_and_keep_channels)
{
    Mat a({1, 2}, CV_32SC3);
    Mat b({1, 2}, CV_32SC3);
...
TEST(MatExpressionTest, compare_with_scalar_and_float_wrappers_work)
{
    Mat a({1, 2}, CV_32SC3);
...
TEST(MatExpressionTest, scalar_expr_paths_reject_more_than_four_channels)
{
