...
TEST(LayoutOpsContract_TEST, masked_copy_matches_scalar_for_common_u8_layouts_and_tail)
{
...
TEST(LayoutOpsContract_TEST, channel_ui_matches_scalar_for_c3_c4_roi_and_tail)
{
...
TEST(LayoutOpsContract_TEST, flip_and_rotate_ui_match_scalar_for_roi_and_tail)
{
